...
` +
    ...
    var qn = On(
      ...
      Xn = On(h({}, kn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Zn = On(
        h({}, In, {
          deltaX: function (e) {
            return `deltaX` in e
      ...
      Qn = On(h({}, kn, { newState: 0, oldState: 0 })),
      $n = [9, 13, 27, 32],
      er = vn && `CompositionEvent` in window,
      tr = null;
    vn && `documentMode` in document && (tr = document.documentMode);
    var nr = vn && `TextEvent` in window && !tr,
      rr = vn && (!er || (tr && 8 < tr && 11 >= tr)),
      ir = ` `,
      ar = !1;
    function or(e, t) {
      switch (e) {
  ...
  for (let e = 0; e < r.length; ++e) {
    ...
    (Object.assign(i, u.params),
      o.push({
        ...
        pathnameBase: Me(je([a, u.pathnameBase])),
        route: d,
      }),
...
He.displayName = `DataRouter`;
var Ue = x.createContext(null);
Ue.displayName = `DataRouterState`;
var We = x.createContext(!1);
function Ge() {
  return x.useContext(We);
}
var Ke = x.createContext({ isTransitioning: !1 });
Ke.displayName = `ViewTransition`;
var qe = x.createContext(new Map());
qe.displayName = `Fetchers`;
var Je = x.createContext(null);
...
var Ze = x.createContext({ outlet: null, matches: [], isDataRoute: !1 });
...
function it(e, { relative: t } = {}) {
  w(at(), `useHref() may be used only in the context of a <Router> component.`);
  let { basename: n, navigator: r } = x.useContext(Ye),
    { hash: i, pathname: a, search: o } = dt(e, { relative: t }),
    s = a;
  return (
    n !== `/` && (s = a === `/` ? n : je([n, a])),
...
function ut() {
  ...
  let e = x.useContext(He),
    { basename: t, navigator: n } = x.useContext(Ye),
    { matches: r } = x.useContext(Ze),
    { pathname: i } = ot(),
  ...
  return (
    ...
    x.useCallback(
      (r, s = {}) => {
        if ((T(o.current, st), !o.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
...
function pt(e, t, n) {
  ...
  let { navigator: r } = x.useContext(Ye),
...
var ht = x.createElement(mt, null),
  gt = class extends x.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
    ...
    render() {
      ...
      return this.context ? x.createElement(vt, { error: e }, t) : t;
    }
  };
gt.contextType = We;
var _t = new WeakMap();
function vt({ children: e, error: t }) {
  let { basename: n } = x.useContext(Ye);
  if (
    typeof t == `object` &&
    t &&
    `digest` in t &&
...
function yt({ routeContext: e, match: t, children: n }) {
  let r = x.useContext(He);
  return (
    r &&
      r.static &&
      r.staticContext &&
    ...
    x.createElement(Ze.Provider, { value: e }, n)
  );
}
function bt(e, t = [], n) {
  let r = n?.state;
  ...
  return (
    ...
    h == null
      ...
      : x.createElement(
          Ye.Provider,
          { value: c },
          x.createElement(Xe.Provider, { children: t, value: h }),
        )
  );
}
...
var Cn =
  ...
  window.document.createElement !== void 0;
try {
  Cn && (window.__reactRouterVersion = `7.14.0`);
} catch {}
function wn({
  basename: e,
  children: t,
...
var En = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Dn = x.forwardRef(function (
    ...
    let b = it(l, { relative: r }),
      ...
      S = null;
    if (o) {
      let e = Ae(o, [], ee.unstable_mask ? ee.unstable_mask.pathname : `/`, !0);
    ...
    return C && !v
      ? x.createElement(x.Fragment, null, re, x.createElement(vn, { page: b }))
      : re;
  });
Dn.displayName = `Link`;
var On = x.forwardRef(function (
  ...
  let u = dt(a, { relative: c.relative }),
    d = ot(),
    f = x.useContext(Ue),
    { navigator: p, basename: m } = x.useContext(Ye),
    h = f != null && Wn(u) && o === !0,
...
var kn = x.forwardRef(
  (
    ...
    let { unstable_useTransitions: h } = x.useContext(Ye),
      g = Ln(),
      _ = Rn(s, { relative: l }),
...
function Kn({ children: e }) {
  return (0, A.jsx)(`div`, {
    className: `relative h-162 w-182 bg-orange-50 overflow-y-scroll`,
    children: e,
  });
}
function qn() {
  return (0, A.jsxs)(`header`, {
    ...
    children: [
      (0, A.jsx)(`h2`, { children: `Store` }),
      (0, A.jsxs)(`ul`, {
        className: `flex flex-row gap-4`,
        children: [
          (0, A.jsx)(On, { to: `/`, children: `Home` }),
          (0, A.jsx)(On, { to: `/about`, children: `About` }),
          (0, A.jsx)(On, { to: `/`, children: `Shop` }),
          (0, A.jsx)(On, { to: `/cart`, children: `Cart` }),
        ],
      }),
    ],
  });
...
function Jn() {
  return (0, A.jsxs)(`section`, {
    className: `p-4 pb-20`,
    children: [
      (0, A.jsx)(`h2`, { className: `text-2xl`, children: `About` }),
      (0, A.jsx)(`p`, {
        className: `text-gray-700`,
        children: `Welcome to our store — where quality meets convenience.`,
      }),
      (0, A.jsx)(`p`, {
        className: `my-4 text-gray-700`,
        children: `We are dedicated to providing our customers with a seamless online shopping experience, offering a carefully curated selection of products that combine style, functionality, and value. Our goal is simple: to make premium products accessible while maintaining exceptional service and trust.`,
      }),
      (0, A.jsx)(`p`, {
        className: `my-4 text-gray-700`,
        children: `Founded with a passion for innovation and customer satisfaction, our store focuses on delivering items that meet modern needs and expectations. Every product we offer is chosen with attention to detail, ensuring it aligns with our standards of quality and reliability.`,
      }),
      (0, A.jsx)(`p`, {
        className: `my-4 text-gray-700`,
        children: `We believe shopping should be easy, enjoyable, and secure. That’s why we continuously improve our platform, streamline our processes, and prioritize fast delivery and responsive support.`,
      }),
      (0, A.jsx)(`h3`, {
      ...
      (0, A.jsxs)(`ol`, {
        ...
        children: [
          (0, A.jsxs)(`li`, {
            className: `text-gray-700`,
            children: [` `, `High-quality, carefully selected products`],
          }),
          (0, A.jsx)(`li`, {
            className: `text-gray-700`,
            children: `Transparent pricing with no hidden costs`,
          }),
          (0, A.jsx)(`li`, {
            className: `text-gray-700`,
          ...
          (0, A.jsx)(`li`, {
            className: `text-gray-700`,
            children: `Dedicated customer support`,
          }),
          (0, A.jsx)(`li`, {
            className: `text-gray-700`,
            children: `Secure and easy checkout experience`,
          }),
        ],
      }),
      (0, A.jsx)(`h3`, { className: `text-2xl`, children: `Our Mission` }),
      (0, A.jsx)(`p`, {
        className: `my-4 text-gray-700`,
        children: `To simplify online shopping by delivering quality products and building long-term relationships with our customers through trust, consistency, and excellent service.`,
      }),
      (0, A.jsx)(`h3`, { className: `text-2xl`, children: `Our Vision` }),
      (0, A.jsx)(`p`, {
        className: `text-gray-700 my-4`,
        children: `To become a trusted global destination for online shopping by continuously evolving with customer needs and market trends.`,
      }),
      (0, A.jsx)(`h3`, {
        className: `underline hover:text-orange-900 text-orange-600 cursor-pointer w-fit `,
        children: `Go to home`,
      }),
    ],
  });
}
function Yn({ text: e, style: t, link: n }) {
  return (0, A.jsx)(Dn, {
    to: n,
    className: `${t} text-lg px-10 cursor-pointer py-1.5 border rounded-lg bg-orange-300 border-orange-400 hover:bg-orange-500 text-white`,
    children: e,
  });
}
function Xn() {
  return (0, A.jsx)(`div`, {
    ...
    children: (0, A.jsxs)(`div`, {
      className: `h-[350px] w-[450px] border rounded-lg bg-orange-100 border-orange-200 p-4`,
      children: [
        (0, A.jsxs)(`div`, {
          className: `h-1/2`,
          children: [
            (0, A.jsx)(`h2`, {
              className: `text-2xl`,
              children: `Login To Store`,
            }),
            (0, A.jsx)(`p`, {
              children: `Lorem ipsum dolor, sit amet consectetur adipisicing elit. Inventore quis quod quam fugit nisi suscipit eius? Illo non incidunt eos!`,
            }),
            (0, A.jsx)(`p`, {
        ...
        (0, A.jsxs)(`div`, {
          className: `flex flex-col gap-1 items-center justify-center h-1/2`,
          children: [
            (0, A.jsxs)(`div`, {
              className: `flex h-10 w-full gap-1`,
              children: [
                (0, A.jsx)(Yn, {
                  link: `/`,
                  style: `w-1/2`,
...
function Zn() {
  return (0, A.jsxs)(`div`, {
    className: `h-fit w-full p-4 realtive`,
    children: [
      (0, A.jsx)(`h2`, { children: `Your Cart` }),
      (0, A.jsx)(`div`, {
        className: `border-t my-2`,
        children: (0, A.jsxs)(`div`, {
          className: `flex justify-between items-center my-4 border-b pb-3 border-slate-400`,
          children: [
            (0, A.jsx)(`p`, { children: `Game of Thornes - Chapter One` }),
            (0, A.jsxs)(`div`, {
              className: `flex items-center gap-2`,
              children: [
                (0, A.jsx)(`p`, { className: `mr-4 text-lg`, children: `45$` }),
                (0, A.jsx)(`p`, {
                  className: `px-2 border rounded-lg py-0.5`,
                  children: `4`,
                }),
                (0, A.jsx)(Yn, {
                  link: ``,
                  style: `!py-0 !px-2 text-md`,
                  text: `X`,
                }),
              ],
            }),
    ...
    children: (0, A.jsxs)(`form`, {
      ...
      children: [
        ...
        (0, A.jsxs)(`div`, {
          ...
          children: [
            (0, A.jsx)(`label`, { htmlFor: `name`, children: `Your Name` }),
            (0, A.jsx)(`input`, {
              type: `text`,
              placeholder: ``,
              name: `name`,
              ...
              children: [
                (0, A.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, A.jsx)(`input`, { type: `text`, name: `street` }),
                  ],
                }),
                (0, A.jsxs)(`div`, {
                  className: `flex w-1/2 flex-col`,
                  children: [
                    (0, A.jsx)(`label`, { htmlFor: `city`, children: `City` }),
                    (0, A.jsx)(`input`, { type: `text`, name: `city` }),
                  ],
                }),
              ],
            }),
            ...
            (0, A.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, A.jsx)(`input`, { type: `text`, name: `country` }),
              ],
            }),
            (0, A.jsxs)(`div`, {
              className: `flex-col flex`,
              children: [
                (0, A.jsx)(`label`, { htmlFor: `phone`, children: `Phone` }),
                (0, A.jsx)(`input`, { type: `number`, name: `phone` }),
              ],
            }),
            (0, A.jsx)(Yn, {
              link: `/payment`,
...
var or = (e, t, ...n) => t.read(...n),
  sr = (e, t, ...n) => t.write(...n),
  cr = (e, t) => t.INTERNAL_onInit?.call(t, e),
  lr = (e, t, n) => t.onMount?.call(t, n),
  ur = (e, t) => {
    var n;
    let r = j(e),
      i = r[0],
  ...
  fr = (e) => {
    ...
    for (; d.length; ) {
      ...
      l.add(t);
      for (let e of ar(t, i, n)) l.has(e) || d.push(e);
    }
  ...
  pr = (e, t) => {
    ...
    let i = j(e),
      ...
      b = v[0];
    if (tr(y)) {
      if ((a.has(t) && o.get(t) !== y.n) || y.m === b) return ((y.m = b), y);
      let n = !1;
      for (let [t, r] of y.d)
        if (p(e, t).n !== r) {
          n = !0;
    ...
    let x = !0,
      ...
      S = new Map(),
      C = () => {
        for (let e of ee) S.has(e) || y.d.delete(e);
      },
      w = () => {
        if (a.has(t)) {
          let n = !s.size;
  ...
  hr = (e, t, ...n) => {
    let r = j(e),
      ...
      v = (n, ...r) => {
        ...
        try {
          if (n === t) {
            if (!$n(n)) throw Error(`atom not writable`);
            let t = u.n,
              s = r[0];
            (m(e, n, s),
              p(e, n),
              t !== u.n &&
                (++h[0], i.add(n), d(e, n), (o = a.c) == null || o.call(a, n)));
            return;
          } else return f(e, n, ...r);
        } finally {
          g || (l(e), c(e));
  ...
  yr = (e, t, n) => {
    let r = j(e),
      ...
      s = `v` in o,
      c = o.v;
    if (rr(n)) for (let r of o.d.keys()) ir(t, n, i(e, r));
    ((o.v = n),
      delete o.e,
      (!s || !Object.is(c, o.v)) && (++o.n, rr(c) && a(e, c)));
  },
  br = (e, t) => {
    let n = j(e)[14];
    return nr(n(e, t));
...
function Dr(...e) {
  ...
  return (Tr.set(t, Object.freeze(n)), t);
}
var Or = 0;
function kr(e, t) {
  let n = `atom${++Or}`,
...
var Ir = (0, x.createContext)(void 0);
function Lr(e) {
  let t = (0, x.useContext)(Ir);
  return e?.store || t || Fr();
}
var Rr = (e) => typeof e?.then == `function`,
  zr = (e) => {
    e.status ||
      ((e.status = `pending`),
      e.then(
          ...
          let s = t,
            ...
            u = () => {
              try {
                let t = n();
                Rr(t)
                  ? (Vr.set(t, i), (s = t), t.then(c(t), l(t)), r(e, t, u))
                  : a(t);
              } catch (e) {
                o(e);
              }
...
function Ur(e, t) {
  let { delay: n, unstable_promiseStatus: r = !x.use } = t || {},
    i = Lr(t),
    [[a, o, s], c] = (0, x.useReducer)(
      (t) => {
        let n = i.get(e);
...
function Wr(e, t) {
  let n = Lr(t);
  return (0, x.useCallback)((...t) => n.set(e, ...t), [n, e]);
}
(kr([]), kr([]));
var Gr = kr();
kr();
function Kr({ src: e, alt: t, name: n, style: r }) {
  let i = Wr(Gr);
  return (0, A.jsxs)(`button`, {
    onClick: () => i(!0),
    className: `${r || ``} hover:border-orange-400 border-orange-200 bg-orange-100 flex rounded gap-1 items-center justify-center border px-4 min-w-34 h-20`,
    children: [
      (0, A.jsx)(`img`, { src: e, alt: t, className: `size-12` }),
      (0, A.jsx)(`h3`, { className: `text-xl`, children: n }),
    ],
  });
}
var qr = `data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='utf-8'?%3e%3c!--%20Uploaded%20to:%20SVG%20Repo,%20www.svgrepo.com,%20Generator:%20SVG%20Repo%20Mixer%20Tools%20--%3e%3csvg%20width='800px'%20height='800px'%20viewBox='0%20-0.5%2034%2034'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M33.2538%2016.1292C33.2538%2025.0371%2026.0329%2032.2584%2017.1255%2032.2584C8.21799%2032.2584%200.99707%2025.0371%200.99707%2016.1292C0.99707%207.22128%208.21799%200%2017.1255%200C26.0329%200%2033.2538%207.22128%2033.2538%2016.1292ZM21.0002%2010.1366C23.2438%2010.9071%2024.8849%2012.0607%2024.5629%2014.2077C24.3291%2015.7799%2023.4543%2016.5403%2022.2921%2016.8065C23.8866%2017.6335%2024.4301%2019.2029%2023.9251%2021.1005C22.9664%2023.8314%2020.6874%2024.0613%2017.6562%2023.4905L16.9202%2026.4261L15.1434%2025.9844L15.8693%2023.0882C15.4087%2022.9742%2014.9379%2022.8522%2014.4529%2022.7221L13.724%2025.6325L11.9492%2025.1908L12.6842%2022.2491L9.10534%2021.3496L9.98817%2019.3226C9.98817%2019.3226%2011.2982%2019.6685%2011.28%2019.6433C11.7832%2019.7673%2012.0069%2019.4406%2012.095%2019.2238L14.0895%2011.256C14.1117%2010.8798%2013.9811%2010.4059%2013.2613%2010.2264C13.2886%2010.2072%2011.9705%209.90669%2011.9705%209.90669L12.4433%208.01585L16.0272%208.90026L16.7562%205.99188L18.532%206.43358L17.8182%209.28448C18.2961%209.39238%2018.776%209.5023%2019.2427%209.61828L19.9514%206.78553L21.7282%207.22724L21.0002%2010.1366ZM16.7488%2014.9882C17.9591%2015.3091%2020.5928%2016.0074%2021.0519%2014.1765C21.5202%2012.3033%2018.9615%2011.7376%2017.7087%2011.4606L17.7086%2011.4606L17.7085%2011.4606C17.5666%2011.4292%2017.4414%2011.4015%2017.3393%2011.3761L16.4545%2014.9117C16.5388%2014.9325%2016.6378%2014.9588%2016.7488%2014.9882ZM15.3775%2020.6807C16.8271%2021.0626%2019.9976%2021.8977%2020.5021%2019.8803C21.0185%2017.8175%2017.9445%2017.1305%2016.4446%2016.7952L16.4441%2016.7951C16.2767%2016.7577%2016.129%2016.7247%2016.008%2016.6946L15.032%2020.5913C15.1311%2020.6158%2015.2472%2020.6464%2015.3771%2020.6806L15.3775%2020.6807Z'%20fill='%23F7931A'/%3e%3c/svg%3e`,
  Jr = `data:image/svg+xml;base64,`,
  Yr = `data:image/svg+xml;base64,`,
  Xr = `data:image/svg+xml;base64,`;
function Zr({ currency_icon: e, currency_address: t }) {
  let [n, r] = (0, x.useState)(!1),
    i = Ur(Gr),
    a = Wr(Gr),
    o = t || `TQ9hYy7Y8wX1pK2mL8ZsF4nJ6cR3vB1uAa`;
  return (0, A.jsx)(`div`, {
    className: `${i ? `fixed` : `hidden`} top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white border h-[450px] w-[250px] rounded p-3`,
    children: (0, A.jsxs)(`div`, {
      className: `h-full w-full flex gap-2 flex-col items-center justify-center px-1`,
      children: [
        (0, A.jsx)(`img`, {
          src:
            e ||
        ...
        (0, A.jsx)(`p`, { children: `Network: TRC-20` }),
        (0, A.jsx)(`p`, { children: `Amount: $45` }),
        (0, A.jsx)(`p`, {
        ...
        (0, A.jsxs)(`div`, {
          ...
          children: [
            (0, A.jsxs)(`div`, {
              ...
              children: [
                (0, A.jsx)(`span`, { className: `truncate`, children: o }),
                (0, A.jsx)(`span`, {
        ...
        (0, A.jsx)(`button`, {
          className: `px-8 py-2 w-full rounded border hover:border-orange-400 border-orange-200 bg-orange-100`,
          children: `Payment Done`,
        }),
        (0, A.jsx)(`button`, {
          onClick: () => a(!1),
          className: `px-8 py-2.5 w-full rounded bg-black text-white`,
          children: `Cancel`,
        }),
      ],
    }),
        ...
        children: [
          (0, A.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, A.jsxs)(`div`, {
                className: `flex justify-between px-4 text-xl mt-4 border-b border-gray-400`,
                children: [
                  (0, A.jsx)(`p`, { children: `Product Name` }),
                  (0, A.jsx)(`p`, { children: `45$` }),
                ],
              }),
            ],
          }),
...
function $r() {
  return (0, A.jsx)(`div`, { children: `Home` });
}
function ei() {
  return (0, A.jsx)(`div`, {
    className: `flex h-screen w-screen items-center justify-center bg-slate-900`,
    children: (0, A.jsxs)(Kn, {
      children: [
        (0, A.jsx)(qn, {}),
        (0, A.jsx)(`div`, {
          className: `w-full flex py-1 gap-1 h-full`,
          children: (0, A.jsxs)(It, {
            children: [
              (0, A.jsx)(Pt, { path: `/`, element: (0, A.jsx)($r, {}) }),
              (0, A.jsx)(Pt, { path: `/auth`, element: (0, A.jsx)(Xn, {}) }),
              (0, A.jsx)(Pt, {
                path: `/delivery`,
                element: (0, A.jsx)(Qn, {}),
              }),
              (0, A.jsx)(Pt, { path: `/about`, element: (0, A.jsx)(Jn, {}) }),
              (0, A.jsx)(Pt, { path: `/cart`, element: (0, A.jsx)(Zn, {}) }),
              (0, A.jsx)(Pt, { path: `/payment`, element: (0, A.jsx)(Qr, {}) }),
            ],
          }),
        }),
      ],
...
(0, g.createRoot)(document.getElementById(`root`)).render(
  (0, A.jsx)(wn, { children: (0, A.jsx)(ei, {}) }),
);
