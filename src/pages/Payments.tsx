    ...
    <div className="p-2 w-full">
      <div>
        ...
        <div className="flex gap-1 mt-4">
          <MethodIcon  style={'flex-1'} src={bitcoin_icon} alt="bitcoin" name="Bitcoin" />
          <MethodIcon  style={'flex-1'} src={theter_icon} alt="bitcoin" name="USDT" />
          <MethodIcon  style={'flex-1'} src={monero_icon} alt="bitcoin" name="Monero" />
          <MethodIcon  style={'flex-1'} src={etherum_icon} alt="bitcoin" name="Ethereum" />
        </div>
      </div>
